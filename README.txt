...
La clase se ha de compilar con la herramienta Travis de integraciC3n continua. 
AdemC!s se ha de comprobar el funcionamiento de la herramienta Guard de comprobaciC3n continua (Continuous testing) de manera que permita la ejecuciC3n de las pruebas definidas con rspec cuando se modifiquen.
2.- Indicar la direcciC3n del repositorio github o bitbucket donde se ha hecho el desarrollo.
